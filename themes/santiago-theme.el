;;; santiago-theme.el
;;; Based on zaiste-theme.el
;;; https://github.com/zaiste/zaiste-emacs-theme
(require 'doom-themes)

(defgroup santiago-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(def-doom-theme santiago
  ...
  ((font-lock-comment-face
   ...
   (org-special-keyword :foreground base8 :underline nil)
   (org-document-title :foreground base8 :weight 'bold :height 1.5)
   (org-document-info-keyword :foreground base4 :height 0.9)
   (org-block-begin-line :foreground base4 :height 0.9)
   (org-meta-line :foreground base4 :height 0.9)
   (org-list-dt :foreground magenta)

   (org-todo-keyword-faces
    '(("TODO" :foreground "#50a14f" :weight normal :underline t)
      ("LATER" :foreground "#9f7efe" :weight bold :underline nil)
      ("NEXT" :foreground "#0098dd" :weight bold :underline nil)
      ("NOW" :foreground "#50a14f" :weight bold :underline nil)
...
(after! org
  (setq
   org-ellipsis " …"
   org-todo-keyword-faces
   '(("TODO" :foreground "#50a14f" :weight bold :underline nil)
     ("DONE" :foreground "#7c7c75" :weight normal :underline nil)
     ("LATER" :foreground "#9f7efe" :weight bold :underline nil)
     ("NEXT" :foreground "#0098dd" :weight bold :underline nil)
     ("NOW" :foreground "#50a14f" :weight bold :underline nil)
     ("CANCELLED" :foreground "#ff6480" :weight normal :underline t))
   ))
;;; santiago-theme.el ends here
